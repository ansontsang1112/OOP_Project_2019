...
import com.kenny.main.GUI.G2ContactUsGUI;
...
public class G22HomePageGUI {
    ...
    public static void HomePageGUIEXE() {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    G22HomePageGUI window = new G22HomePageGUI();
    ...
    private void initialize() {
        ...
        btnContactUs.addActionListener(arg0 -> G2ContactUsGUI.RegisterGUIEXE());
    }
}
