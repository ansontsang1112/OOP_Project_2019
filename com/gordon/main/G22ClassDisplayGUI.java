...
public class G22ClassDisplayGUI {
        public static void ClassDisplayGUIEXE() {
                try {
                        String datafile = "";
                        if(Main.tempInt == 0) {
                                datafile = "G42M1TSANG.csv";
                        } if(Main.tempInt == 1) {
                                datafile = "G42M2NG.csv";
                        } if(Main.tempInt == 2) {
                                datafile = "G42M3HUNG.csv";
                        } if(Main.tempInt == 3) {
                                datafile = "G42M4CHAK.csv";
                        }
                        ...
                        FileWriter out = new FileWriter(G22Config.getPath(Main.tempInt));
